...
typedef enum {FS_DISK, FS_FTP, FS_RSS, FS_HTTP, FS_HTTPS, FS_WEBDAV, FS_SWEBDAV, FS_IDRIVE, FS_SKYDRIVE, FS_GDRIVE, FS_GSITES, FS_PICASA, FS_FAW, FS_RESTBACKUP, FS_SSH, FS_SHELL, FS_TELNET, FS_TTY} FS_TYPES;
